...
function getEventStyle(importance: string) {
  const styles: Record<string, any> = {
    inciting: { backgroundColor: '#f3e5f5', borderColor: '#7b1fa2', borderWidth: 3 },
    midpoint: { backgroundColor: '#fff9c4', borderColor: '#fbc02d', borderWidth: 3 },
    climax: { backgroundColor: '#ffebee', borderColor: '#c62828', borderWidth: 4 },
    resolution: { backgroundColor: '#e8f5e9', borderColor: '#2e7d32', borderWidth: 2 },
  };
  return styles[importance] || { backgroundColor: '#ffffff', borderColor: '#9e9e9e', borderWidth: 1 };
}