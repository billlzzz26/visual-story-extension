...
export const mockStoryGraph: StoryGraph = {
  ...
  characters: [
    {
      ...
      arc: {
        ...
        emotionalJourney: ['curiosity', 'doubt', 'determination', 'faith', 'triumph'],
      },
    ...
    },
    {
      ...
      arc: {
        ...
        emotionalJourney: ['anger', 'conflict', 'remorse', 'sacrifice', 'peace'],
      },
  ...
  conflicts: [
    {
      id: 'conflict-1',
      type: 'external',
      description: 'The Empire seeks to crush the Rebellion and maintain control of the galaxy through fear and military power.',
      relatedCharacters: ['char-1', 'char-2'],
      rootCause: 'Imperial oppression and tyranny',
      escalations: [
        { stage: 1, description: 'Death Star construction', intensity: 7, affectedCharacters: ['char-1', 'char-2'] },
        { stage: 2, description: 'Princess Leia captured', intensity: 8, affectedCharacters: ['char-1'] },
        { stage: 3, description: 'Battle of Yavin', intensity: 10, affectedCharacters: ['char-1', 'char-2'] },
      ],
    ...
    },
    {
      id: 'conflict-2',
      type: 'internal',
      description: 'Luke must choose between his desire for adventure and his responsibility to the greater good.',
      relatedCharacters: ['char-1'],
      rootCause: 'Luke\'s naivety and longing for purpose',
      escalations: [
        { stage: 1, description: 'Uncle Owen\'s refusal', intensity: 4, affectedCharacters: ['char-1'] },
        { stage: 2, description: 'R2-D2\'s message', intensity: 6, affectedCharacters: ['char-1'] },
        { stage: 3, description: 'Final choice to face Vader', intensity: 9, affectedCharacters: ['char-1'] },
      ],
  ...
  events: [
    {
      ...
      description: 'Luke discovers the droids carrying a message from Princess Leia.',
      act: 1,
      importance: 'inciting',
      sequenceInAct: 1,
    ...
    },
    {
      ...
      description: 'Obi-Wan reveals the truth about Luke\'s father and gives him his father\'s lightsaber.',
      act: 1,
      importance: 'rising',
      sequenceInAct: 2,
    ...
    },
    {
      ...
      description: 'Luke decides to join the Rebellion after his aunt and uncle are killed.',
      act: 1,
      importance: 'rising',
      sequenceInAct: 3,
      location: 'Tatooine - Moisture Farm',
    ...
    },
    {
      id: 'event-4',
      label: 'The Midpoint',
      description: 'Luke faces Vader in the Death Star trench and experiences the Force for the first time.',
      act: 2,
      importance: 'midpoint',
      sequenceInAct: 1,
    ...
    },
    {
      id: 'event-5',
      label: 'The Climax',
      description: 'The final battle - Luke must trust the Force to destroy the Death Star.',
      act: 3,
      importance: 'climax',
      sequenceInAct: 1,
  ...
  relationships: [
    { from: 'char-1', to: 'char-3', type: 'mentor', strength: 9, description: 'Obi-Wan trains and guides Luke' },
    { from: 'char-1', to: 'char-2', type: 'enemy', strength: 8, description: 'Vader hunts Luke across the galaxy' },
    { from: 'char-3', to: 'char-2', type: 'former friend', strength: 5, description: 'Once friends, now enemies' },
  ],
