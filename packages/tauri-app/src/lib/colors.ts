export function getImportanceColor(importance: string): { bg: string; text: string } {
...
export function getIssueColor(severity: string): { bg: string; text: string; border: string } {
