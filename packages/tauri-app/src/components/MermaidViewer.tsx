...
export function MermaidViewer({ diagram }: MermaidViewerProps): React.ReactElement {
  return (
    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
      <h2 className="text-lg font-semibold text-slate-800 mb-4">Story Flow Diagram</h2>
