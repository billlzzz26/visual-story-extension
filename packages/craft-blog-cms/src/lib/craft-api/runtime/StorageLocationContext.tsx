...
const StorageLocationContext = createContext<StorageLocationContextValue>(DEFAULT_STORAGE_CONTEXT)
...
export function StorageLocationProvider({
  ...
  return <StorageLocationContext.Provider value={value}>{children}</StorageLocationContext.Provider>
}
