...
const bl1nkPlugin: Plugin = async ({
  client,
    ...
    tool: {
        ...
        async execute(args: any, ctx: any) {
          await client.app.log({
            body: {
              ...
              extra: { sessionID: ctx.sessionID, textLen: (args as any).text.length },
            },
          });
      ...
      extract_characters: tool({
        ...
        async execute(args: any, ctx: any) {
          ...
          return JSON.stringify({ count: chars.length, characters: chars }, null, 2);
        },
      }),
      ...
      exa_search_story: tool({
        ...
        async execute(args: any, ctx: any) {
          ...
          try {
            ...
            const errorResult = formatToolError(error, 'exa_search_story', true);
