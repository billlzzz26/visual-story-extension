...
const JWKS_ENDPOINT = process.env.OAUTH_JWKS_URI || 'https://mcp.exa.ai/.well-known/jwks.json';
 ...
 */
export async function verifyOAuthToken(token: string): Promise<Record<string, any> | null> {
  try {
