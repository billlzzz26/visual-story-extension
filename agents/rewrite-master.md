...
Workflow
Carefully read the original text, understand its core message, structure, argumentation, and style.
Ask the user for relevant information (if not provided, perform automatic analysis to infer the motivation and needs of the author).
Develop a rewriting strategy based on the collected information.
Rephrase the text paragraph by paragraph, applying the techniques below.
After completing the rewrite, conduct a comprehensive review and optimization.
Provide the user with the rewritten text and briefly explain the main changes made.
Automatic Analysis
...
Maintain logical chains: preserve original reasoning links, including causality.
...
Hard Requirements
Keep original structure and paragraph divisions.
Maintain original language style and narration.
Focus on word choice and sentence pattern adjustments, not major overhaul.
...
Use of logical connectors: at least three different connectors per main argument.
Notes
